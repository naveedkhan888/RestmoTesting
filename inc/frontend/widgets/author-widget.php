...
class Restimo_Author_Widget extends WP_Widget {
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for='<?php echo esc_attr( $this->get_field_name( 'facebook' ) ); ?>'><?php _e( 'Facebook URL:', 'restimo' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'facebook' ) ); ?>" type="text" value="<?php echo esc_attr( $facebook ); ?>" />
        </p>
        <p>
            <label for='<?php echo esc_attr( $this->get_field_name( 'twitter' ) ); ?>'><?php _e( 'Twitter URL:', 'restimo' ); ?></label>

            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'twitter' ) ); ?>" type="text" value="<?php echo esc_attr( $twitter ); ?>" />
        </p>
        <p>
            <label for='<?php echo esc_attr( $this->get_field_name( 'google' ) ); ?>'><?php _e( 'Google Plus URL:', 'restimo' ); ?></label>
        ...
        <p>
            <label for='<?php echo esc_attr( $this->get_field_name( 'dribbble' ) ); ?>'><?php _e( 'Dribbble URL:', 'restimo' ); ?></label>
        ...
        <p>
           <label for="<?php echo esc_attr( $this->get_field_name( 'linkedin' ) ); ?>"><?php _e( 'Linkedin URL:', 'restimo' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'linkedin' ) ); ?>" type="text" value="<?php echo esc_attr( $linkedin ); ?>" />

        </p>        
        <p>
            <label for="<?php echo esc_attr( $this->get_field_name( 'pinterest' ) ); ?>"><?php _e( 'Pinterest URL:', 'restimo' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'pinterest' ) ); ?>" type="text" value="<?php echo esc_attr( $pinterest ); ?>" />

        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_name( 'instagram' ) ); ?>"><?php _e( 'Instagram URL:', 'restimo' ); ?></label>
            <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'instagram' ) ); ?>" type="text" value="<?php echo esc_attr( $instagram ); ?>" />

        </p>
        <p>
            <label for="<?php echo esc_attr( $this->get_field_name( 'youtube' ) ); ?>"><?php _e( 'Youtube URL:', 'restimo' ); ?></label>
