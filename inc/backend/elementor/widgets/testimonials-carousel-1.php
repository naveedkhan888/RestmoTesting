...
class Restimo_Testimonials extends Widget_Base{
	...
	protected function render() {
		...
		<div class="xp-testimonials xp-testimonials-carousel <?php echo esc_attr( $settings['is_reverse'] === 'yes' ? 'is-reverse' : '' ); ?>" data-auto="<?php echo esc_attr( $settings['autoplay'] ); ?>" 
				...
				<div class="testi-item">
					...
					<div class="t-head flex-middle">
						<?php if($testi['timage']['url']) { ?>
							<div class="tphoto">
							    <img src="<?php echo esc_url( $testi['timage']['url'] ); ?>" alt="<?php echo esc_attr( $testi['tname'] ); ?>">
							</div>
						<?php } ?>
						<div class="tinfo">
