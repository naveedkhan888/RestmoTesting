...
class Restimo_Team_Carousel extends Widget_Base{
	...
	protected function render() {
		...
		?>
		<div class="xp-team-carousel" data-loop="<?php echo esc_attr( $settings['loop'] ); ?>" data-auto="<<?php echo esc_attr( $settings['autoplay'] ); ?>" data-time="<?php echo $settings['timeout']['size']; ?>" data-arrows="<?php echo $settings['arrows']; ?>" data-dots="<?php echo $settings['dots']; ?>" data-show="<?php echo esc_attr( $shows ); ?>" data-tshow="<?php echo esc_attr( $tshows ); ?>" data-mshow="<?php echo esc_attr( $mshows ); ?>" data-gaps="<?php echo esc_attr( $gaps ); ?>" data-tgaps="<?php echo esc_attr( $tgaps ); ?>" data-mgaps="<?php echo esc_attr( $mgaps ); ?>">
				...
				<div class="xp-team team-2 circle-social">
					<div class="team-thumb">
						<?php if( ! empty( $mem['member_image']['url'] ) ) { 
						    echo '<img src="' . esc_url( $mem['member_image']['url'] ) . '" alt="">'; 
						} ?>
					</div>
					<div class="team-info">
